...
class TrainDatasetOrientation(Dataset):
    ...
    def __getitem__(self, index):
        ...
        return (a_img_tensor, p_img_tensor, n_img_tensor), (pose_tensor, p_pose_tensor, n_pose_tensor), a_id_index
...
class TrainDataset(Dataset):
    ...
    def __getitem__(self, index):
        ...
        pid_index = self.id_to_idx[pid]

        return img_tensor, pose_tensor, cloth_id, pid_index
