...
class Baseline(LightningModule):
    ...
    def training_step(self, batch, batch_idx) -> Dict:
        ...
        # Warm Up
        warm_iteration = round(self.dataset_size/BASIC_CONFIG.BATCH_SIZE)*BASIC_CONFIG.WARM_EPOCH # first 5 epoch
        if self.current_epoch < self.warm_epoch:
            warm_up = min(1.0, BASIC_CONFIG.WARM_UP + 0.9 / warm_iteration)
            loss = loss * warm_up
