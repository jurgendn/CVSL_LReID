...
def evaluate(gallery, query):
    ...
    for i in range(len(query_label)):
        ap_tmp, CMC_tmp = _evaluate(query_feature[i], query_label[i],
...
def evaluate2(gallery, query):
    ...
    ap = 0.0
    for i in range(len(query_label)):
        ap_tmp, CMC_tmp = _evaluate2(query_feature[i], query_label[i],
...
def _evaluate2(qf, ql, qc, qcl, gf, gl, gc, gcl):
    ...
    good_index = np.setdiff1d(good_index, cloth_index,
