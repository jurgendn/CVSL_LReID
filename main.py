...
market = Market1501(image_folder=cfg.DATAPATH, transforms=transform)
loader = DataLoader(dataset=market, batch_size=cfg.BATCH_SIZE)
...
file_name = list(map(get_filename, market.image))
